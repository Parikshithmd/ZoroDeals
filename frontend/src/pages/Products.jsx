...
function Products() {
   ...
   const categories=["mobile", "fruits", "laptop","shirt","shoes","pants","glass","car","watch","cookies","Pomegranate","socks","bag","mouse","headphone","bucket","bangle","ring","lcd","jacket","tops"];
